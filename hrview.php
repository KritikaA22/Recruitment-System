...
<html>
    <head>
        ...
        <style>
            .hero-image {
            background-image:url("pictures/hrview.png");
...
<div class="site-footer">
                ...
                <div class="row">
                  <div class="col-sm-12 col-md-6">
                      <h6> Role </h6>
                    <p><?php echo $row['Rolename']; ?></p> <br>
                    <h6> Location </h6>
                    <p> <?php echo $row['Location']; ?></p> <br>
                    <h6> Stipend </h6>
                    <p> <?php echo $row['Stipend']; ?></p> <br>
                    <h6> Description </h6>
                    <p> <?php echo $row['JobDescription']; ?></p> <br>
                    <h6> Requirements </h6>
                    <p> <?php echo $row['Requirements']; ?></p> <br>
                    <h6> Job Takeaways </h6>
                    <p> <?php echo $row['Takeaways']; ?></p> <hr style="width:200%;">
                        </div>
                      ...
                      <div class="col-xs-6 col-md-3">
                          <ul class="footer-links">
                            <h6><a href="viewapp.php?ID=<?php echo $row['JobID']; ?>" style="color:white;">View applications</a></h6>
                            <h6><a href="shortlistapp.php?ID=<?php echo $row['JobID']; ?>" style="color:white;">Shortlisted applications</a></h6>
                            <h6><a href="shortlistfinal.php?ID=<?php echo $row['JobID']; ?>" style="color:white;">Final applicants</a></h6>
                          </ul>
                        </div>
                </div>
                <?php
