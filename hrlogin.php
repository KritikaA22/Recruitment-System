...
<title>HR Sign-in</title>
  ...
  <style>
      .hero-image {
            background-image:url("pictures/hrlogin.png");
...
<a class="active" href="home.html">Home</a>
  ...
  <h1 style="margin-top:150px; font-size:50px;">HR Login</h1>
  ...
  <button class="button1"><a href="home.html" style="color:white;">Home</a></button>
				...
				<div class="hpanel">
                    <div class="panel-body">
                        <form action="" name="form1" method="post">
                            ...
                            <a class="btn btn-default btn-block" href="user reg.php">Register</a>
    ...
    <?php
        ...
        {
            $count=0;
            $res=mysqli_query($sql,"select * from HR where username='$_POST[username]' && password='$_POST[password]'");
