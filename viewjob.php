...
<html>
    <head>
        ...
        <style>
            .hero-image {
            background-image:url("pictures/viewjob.png");
                    ...
                    <p> <?php echo $row['Takeaways']; ?></p> <hr style="width:200%;">
                      ...
                      <div class="col-xs-6 col-md-3">
                          <ul class="footer-links">
                            <h6><a href="editjob.php?ID=<?php echo $row['JobID']; ?>" style="color:white;">Edit job </a></h6>
                            <h6><a href="deletejob.php?ID=<?php echo $row['JobID']; ?>" style="color:white;">Delete job </a></h6>
                          </ul>
                        </div>
                </div>
                <?php
