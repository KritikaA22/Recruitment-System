...
<html>
    <head>
                                        ...
                                        while($row=mysqli_fetch_array($res)) 
                                        {
                                            ?>
                                                <tr>
                                                    ...
                                                    <td> <a href="finalrecruit.php?username=<?php echo $row["Username"];?>&id=<?php echo $id;?>">Recruit</a></td>
        ...
        {
           mysqli_query($sql,"update Application set TestLink='$_POST[testlink]', InterviewLink='$_POST[intlink]' where JobID=$id and ApplicationStatus='Resume approved';");
          ?>
